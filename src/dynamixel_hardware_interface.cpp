...
namespace dynamixel_hardware_interface
{
    ...
    const hardware_interface::HardwareInfo& info)
  {
    ...
    get_dxl_data_srv_ = create_service<dynamixel_msgs::srv::GetDataFromDxl>(
    ...
    set_dxl_data_srv_ = create_service<dynamixel_msgs::srv::SetDataToDxl>(
    ...
    reboot_dxl_srv_ = create_service<dynamixel_msgs::srv::RebootDxl>(
